...
results <- jaspTools::runAnalysis("LDtriangular",
                                  data.frame(triangular = jaspDistributions:::rtriangular(n = 100, -1, 0, 0)),
                                  options)
...
test_that("Estimated Parameters table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-0.891317307885553, -0.969576216603351, "a", 0.0399287483520583,
                                      -0.813058399167756, 0.926436273265075, 0.833855517805458, "b",
                                      0.0472359472877471, 1.01901702872469, -0.022636934371412, -0.0584371803743488,
                                      "c", 0.0182657672719114, 0.0131633116315248))
})
...
test_that("Fit Statistics table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.802721108000785, 0.0643030863580119, "Kolmogorov-Smirnov", 0.73042073241695,
                                      0.0736585513141384, "Cram<unicode>r-von Mises", 0.821622994509396,
                                      0.426618952262345, "Anderson-Darling"))
})
