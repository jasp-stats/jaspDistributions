...
test_that("Empirical vs. Theoretical CDF plot matches", {
  ...
  jaspTools::expect_equal_plots(testPlot, "empirical-vs-theoretical-cdf", dir="LDtriangular")
})
...
test_that("Histogram vs. Theoretical PDF plot matches", {
  ...
  testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
  jaspTools::expect_equal_plots(testPlot, "histogram-vs-theoretical-pdf", dir="LDtriangular")
})
...
test_that("P-P plot matches", {
  ...
  testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
  jaspTools::expect_equal_plots(testPlot, "p-p-plot", dir="LDtriangular")
})
