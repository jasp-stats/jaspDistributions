...
LDlogLogistic <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDlogLogistic)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDlogLogistic", "LDlogLogistic.qml", options, version, TRUE))
}