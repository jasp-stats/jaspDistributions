...
LDnegbinomial <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDnegbinomial)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDnegbinomial", "LDnegbinomial.qml", options, version, TRUE))
}