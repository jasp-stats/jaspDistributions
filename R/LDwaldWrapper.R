...
LDwald <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDwald)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDwald", "LDwald.qml", options, version, TRUE))
}