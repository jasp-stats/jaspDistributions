...
LDgeometric <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDgeometric)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDgeometric", "LDgeometric.qml", options, version, TRUE))
}