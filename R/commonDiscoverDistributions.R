...
.ldSummaryContinuousTableMain <- function(dataContainer, variable, options, ready) {
  ...
  summaryTable$addColumnInfo(name = "mean",       title = gettext("Mean"),           type = "number", format = "dp:2")
  summaryTable$addColumnInfo(name = "var",        title = gettext("Variance"),       type = "number", format = "dp:2")
  summaryTable$addColumnInfo(name = "sd",         title = gettext("Std. deviation"), type = "number", format = "dp:2")
  summaryTable$addColumnInfo(name = "min",        title = gettext("Minimum"),        type = "number", format = "dp:2")
  summaryTable$addColumnInfo(name = "quantile25", title = gettextf("25%% Quantile"),   type = "number", format = "dp:2")
  summaryTable$addColumnInfo(name = "median",     title = gettext("Median"),         type = "number", format = "dp:2")
  summaryTable$addColumnInfo(name = "quantile75", title = gettextf("75%% Quantile"),   type = "number", format = "dp:2")
  summaryTable$addColumnInfo(name = "max",        title = gettext("Maximum"),        type = "number", format = "dp:2")
