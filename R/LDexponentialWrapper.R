...
LDexponential <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDexponential)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDexponential", "LDexponential.qml", options, version, TRUE))
}