...
LDtriangular <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDtriangular)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDtriangular", "LDtriangular.qml", options, version, TRUE))
}