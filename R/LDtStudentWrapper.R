...
LDtStudent <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDtStudent)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDtStudent", "LDtStudent.qml", options, version, TRUE))
}