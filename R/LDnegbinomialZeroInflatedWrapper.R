...
LDnegbinomialZeroInflated <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDnegbinomialZeroInflated)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDnegbinomialZeroInflated", "LDnegbinomialZeroInflated.qml", options, version, TRUE))
}