...
LDlognormal <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDlognormal)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDlognormal", "LDlognormal.qml", options, version, TRUE))
}