...
LDnormalGeneralized <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDnormalGeneralized)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDnormalGeneralized", "LDnormalGeneralized.qml", options, version, TRUE))
}