...
LDmixtureNormalUniform <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDmixtureNormalUniform)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDmixtureNormalUniform", "LDmixtureNormalUniform.qml", options, version, TRUE))
}