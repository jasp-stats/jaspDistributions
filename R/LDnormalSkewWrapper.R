...
LDnormalSkew <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDnormalSkew)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDnormalSkew", "LDnormalSkew.qml", options, version, TRUE))
}