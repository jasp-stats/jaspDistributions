...
LDgompertz <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDgompertz)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDgompertz", "LDgompertz.qml", options, version, TRUE))
}