...
#'    Defaults to \code{FALSE}.
#' @param min, Select the bounds of the ordered set to display: Density is highlighted at the lower and upper bounds, the probability is displayed for the specified interval.
#' @param min_x, Defines the limits of the x-axis of the probability density plot and cumulative distribution plot.
...
#'    Defaults to \code{FALSE}.
#' @param plotCMF, Displays the cumulative distribution plot
#'    Defaults to \code{FALSE}.
#' @param plotPMF, Displays the probability mass plot
...
#'    Defaults to \code{FALSE}.
#' @param prob, probability of "success". This parameter can be freely estimated from the data.
...
#' @param size, number of trials. This parameter is fixed when fitting the data.
...
LDbinomial <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDbinomial)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDbinomial", "LDbinomial.qml", options, version, TRUE))
}