...
LDbetaStretched <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDbetaStretched)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDbetaStretched", "LDbetaStretched.qml", options, version, TRUE))
}