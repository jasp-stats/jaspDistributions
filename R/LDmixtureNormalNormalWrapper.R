...
LDmixtureNormalNormal <- function(
          data = NULL,
          version = "0.95",
   ...
   defaultArgCalls <- formals(jaspDistributions::LDmixtureNormalNormal)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDmixtureNormalNormal", "LDmixtureNormalNormal.qml", options, version, TRUE))
}