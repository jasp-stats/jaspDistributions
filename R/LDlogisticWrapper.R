...
LDlogistic <- function(
   ...
   defaultArgCalls <- formals(jaspDistributions::LDlogistic)
   ...
   return(jaspBase::runWrappedAnalysis("jaspDistributions", "LDlogistic", "LDlogistic.qml", options, version, TRUE))
}