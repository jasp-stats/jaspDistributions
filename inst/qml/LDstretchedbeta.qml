...
Form
{
	Section
	{
		...
		Group
		{
			...
			DoubleField{ id: lb; name: "lb"; label: qsTr("lb"); negativeValues: true; max: ub.value; defaultValue: 0 }
			Text { text: qsTr("Upper bound:") }
			DoubleField{ id: ub; name: "ub"; label: qsTr("ub"); negativeValues: true; min: lb.value; defaultValue: 1 }
		}
